...
function Card({username, designation, btnText="Message", myObj, myArr}) {
    console.log(myObj);
    console.log(myArr);
  return (
    <>
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-4 m-4">
